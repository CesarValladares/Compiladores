...
_lr_productions = [
  ...
  ('statement -> ID EQUALS expression','statement',3,'p_statement_assign','Compilador.py',238),
  ('statement -> PRINT expression','statement',2,'p_statement_print','Compilador.py',244),
  ('statement -> ID EQUALS LBRACKET statement RBRACKET','statement',5,'p_statement_list','Compilador.py',249),
  ('statement -> statement COMMA NUMBER','statement',3,'p_statement_list','Compilador.py',250),
  ('statement -> NUMBER','statement',1,'p_statement_list','Compilador.py',251),
  ('statement -> expression','statement',1,'p_statement_expr','Compilador.py',263),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','Compilador.py',268),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','Compilador.py',269),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','Compilador.py',270),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','Compilador.py',271),
  ('expression -> expression EXP expression','expression',3,'p_expression_binop','Compilador.py',272),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','Compilador.py',293),
  ('expression -> ID LBRACKET NUMBER RBRACKET','expression',4,'p_expression_data_in_array','Compilador.py',297),
  ('expression -> NUMBER','expression',1,'p_expression_number','Compilador.py',313),
  ('expression -> STRING','expression',1,'p_expression_string','Compilador.py',317),
  ('expression -> ID','expression',1,'p_expression_ID','Compilador.py',321),
]
